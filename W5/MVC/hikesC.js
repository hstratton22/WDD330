...
export default class HikesController {
  ...
  // in order to show the details of a hike ontouchend we will need to attach a listener 
  //AFTER the list of hikes has been built. The function below does that.
  addHikeListener() {
