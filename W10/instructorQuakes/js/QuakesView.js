export default // Quake View handler
  ...
  renderQuakeList(quakeList, listElement) {
    console.log("inside renderQuakeList line4");
    ...
    */
    listElement.innerHTML = quakeList.features
      .map(quake => {
        console.log("inside QuakesView map line 18");
